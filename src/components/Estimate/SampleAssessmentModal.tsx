...
export default function SampleAssessmentModal({ isOpen, onClose: closeParent }: Props) {
  ...
  const pageContent = [
    <section className="sample-report__cover" key="cover"><SampleMark /><div className="sample-report__cover-logo-glow"><img src={logo} alt="JBTRADESMENLLC" /></div><div className="sample-report__gold-line" /><p className="sample-report__kicker">Professional Property Assessment Report</p><h1>Sample Property</h1><p>123 Example Street<br />Las Vegas, Nevada 89139</p><div className="sample-report__cover-meta"><span>Assessment Type<br /><strong>Residential Property Assessment</strong></span><span>Prepared By<br /><strong>JBTRADESMENLLC</strong></span><span>Report Status<br /><strong>Sample / Demonstration</strong></span></div><footer>Licensed &amp; Insured · OSHA 30 Certified · EPA 608 &amp; 609 Certified<br />Federal Contractor · CAGE Code: 13SR1 · UEI: PKT6EMEN5BJ9</footer></section>,
