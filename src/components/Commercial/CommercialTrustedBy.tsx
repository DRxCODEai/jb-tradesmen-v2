...
const clients = [
  'First Interstate Bank', 'Home Depot', 'Red Lobster', "Michael's Arts & Crafts", 'GNC', 'Sally Beauty', 'Ross', 'TJ Maxx', 'Family Dollar', 'Sprouts Farmers Market', 'Superior Property Management', 'DaVita Dialysis', 'ATD (American Tire Distributors)', 'MasTec',
]
