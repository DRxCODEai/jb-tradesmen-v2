...
export const galleryProjects: GalleryProject[] = [
  ...
  createProject({
    id: 'walgreens-water-heater', title: 'Commercial Water Heater Assessment and Replacement', shortTitle: 'Commercial Water Heater Service', category: 'Commercial',
  ...
  createProject({
    id: 'commercial-stair-repair', title: 'Commercial Metal Stair Reinforcement', shortTitle: 'Metal Stair Reinforcement', category: 'Facility Improvements',
